    ...
    {(props.data.content.layout[0] !== null)
      ? <React.Fragment>
          {(props.data.content.layout[0].module === 'simple_slideshow' && props.data.content.layout[0].slides)
            ? <SlideShow data={props.data.content.layout[0]} page_title={props.title} count={props.count}/> :
            (props.data.content.layout[0].module === 'single_video_photo')
            ? <VideoEmbed data={props.data.content.layout[0]} page_title={props.title}/> : 
            (props.data.content.layout[0].module === 'zoom_image')
            ? <Zoom data={props.data.content.layout[0]} page_title={props.title}/> :
            null
          }
        </React.Fragment>
      : <NotFound/>
